...

{
  ...
  public function behaviors() {
...

    {
        ...
        $model->state_id = Payment::STATE_ACTIVE;
     ...
     * Clone an existing Payment model.
...

    {
        ...
        //$model->id  = $old->id$model->title  = $old->title$model->key  = $old->key$model->value  = $old->value//$model->state_id  = $old->state_id$model->type_id  = $old->type_id$model->create_time  = $old->create_time//$model->created_by_id  = $old->created_by_id
     ...
     * Truncate an existing Payment model.
...

    {
        ...
        \Yii::$app->session->setFlash('success', 'Payment Cleared !!!');
